                    ...
                    <div className="portfolio_wrapper">
                        <ul className="nav flex-column portfolio">
                            <li className="nav-item">
                                <a href="user-portfolio " className="nav-link d-flex align-items-center active">
                    ...
                    <div className="sidebar_footer d-flex align-items-center justify-content-around">
                        ...
                        <div class="right_col">
                            <div class="switch_wrapper">
                                ...
                                <button class="btn switcher actives" id="dark" title="Switch to Dark Theme">
                                        ...
                                        <div className="row">
                                            <div className="col-sm-6 col-lg-4">
                                                <div className="value_wrapper cmn_st">
                                                    <div className="d-flex align-items-center justify-content-between title_wrapper">
                                                        ...
                                                        <p className="value d-flex align-items-center"> <i className="fas fa-plus" />
                                                            09.84% <img src="assets/images/user/arrow.png" alt="Arrow" /></p>
                                                    </div>
                                                    <h5> <i className="	fas fa-dollar-sign" /> 1500.00</h5>
                                            ...
                                            <div className="col-sm-6 col-lg-4">
                                                <div className="balance cmn_st">
                                                    ...
                                                    <h5> <i className="	fas fa-dollar-sign" /> 500.00</h5>
                                                    <div className="chart_wrapper d-flex justify-content-end">
                                                        <div id="balanceChart">
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="col-sm-6 col-lg-4">
                                                <div className="earnings cmn_st">
                                                    <div className="d-flex align-items-center justify-content-between title_wrapper">
                                                        ...
                                                        <p className="value d-flex align-items-center"> <i className="fas fa-plus" />
                                                            09.84% <img src="assets/images/user/arrow.png" alt="Arrow" />
                                                        </p>
                                                    </div>
                                                    <h5> <i className="	fas fa-dollar-sign" /> 450.00</h5>
                                                    <div className="chart_wrapper d-flex justify-content-end">
                                                    ...
                                                    <tr>
                                                        <td className="player_info">
                                                            <div className="wrapper d-flex align-items-center">
                                                                <div className="img_wrapper">
                                                                    <a href="player-profile " className="d-inline-flex align-items-end justify-content-center">
                                                                        <img src="assets/images/user/avatar_1.png" alt="Player One" />
                                                                    </a>
                                                                    <span className="league">NBA</span>
                                                                </div>
                                                                <div className="info_wrapper">
                                                                    <a href="player-profile ">Jessie Berry</a>
                                                                    <p>Oklahoma City Thunder</p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <p className="change d-flex align-items-center"> <i className="fas fa-plus" />
                                                                8.12% <i className="fas fa-caret-down" />
                                                            </p>
                                                        </td>
                                                        <td>
                                                            <p className="price"><i className="fas fa-dollar-sign" /> 3.91</p>
                                                        </td>
                                                        <td>
                                                            <p className="bought"><i className="fas fa-dollar-sign" /> 3.00</p>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <p className="earning d-flex align-items-center">
                                                                <i className="fas fa-dollar-sign" />8.19
                                                            </p>
                                                        </td>
                                                        <td>
                                                            <a href="trade " className="btn btn-primary sell_btn">SELL</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td className="player_info">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td className="buy_sell">
                                                            <a href="trade " className="btn btn-primary sell_btn">SELL</a>
                                                            <a href="trade " className="btn btn-primary sell_btn">BUY</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td className="player_info">
