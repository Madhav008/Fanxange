    ...
    return (
        <div>
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl  items-center justify-between mx-auto p-4">
                    <div className=''>
                        ...
                        <div className="text-3xl font-semibold  dark:text-white">Stragic Plan 2023 </div>
                    </div>
                </div>
            </nav>
            ...
            <div className=' w-[100vw]'>
                ...
                <div className="w-[calc(100%-50px)] m-5 text-start p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <dl className=" mt-5 border-t-2 border-gray-400 border- max-w-md text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                        <div className="flex flex-col pb-3 text-sm ml-5 mt-2">
