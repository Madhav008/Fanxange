                        ...
                        <div class="row buy_row d-flex align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="right_inner">
                                    ...
                                    <p class="section_info">Changes in Players Share prices provide a valuable opportunity to
                    ...
                    <div class="row play_row d-flex align-items-center">
                        <div class="col-lg-5">
                            <div class="inner">
                                ...
                                <p class="section_info">Buy, sell or trade your favourite athletes just like stocks on a stock
                                    market.</p>
                                <div class="inner_row d-flex align-items-center">
                                    <div class="inner_col">
                                        <div class="left_col">
                        ...
                        <div class="row invite_row d-flex align-items-center">
                            <div class="col-lg-8">
                                <div class="inner">
                                    ...
                                    <p class="section_info">Once your friends sign up and deposit funds, you'll both get a free
                                        stock!</p>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="inner text-left text-lg-center">
                                    <a href="affiliate.html" class="btn btn-primary">Get Free Stock</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="testimonial_section">
                <div class="container">
                    ...
                    <div class="row testimonial_row">
                        <div class="col-md-6 col-lg-4">
                            <div class="inner">
                                <p class="para">Fanxange is the future of daily fantasy! Trade teams like stocks, build your
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="inner">
                                <p class="para">It is a great idea. It's a ton of fun and I found myself caring about the
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="inner">
                                <p class="para">Investing in sports is the future & I look forward to seeing how Fanxange will
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="accordion-body">
                                        <p class="para">"Trading" refers to the buying and selling of shares of players on the
                ...
                <div class="container">
                    ...
                    <div class="row footer_copyright d-flex align-items-center">
                        <div class="col-lg-7 text-center text-sm-start">
                            <p class="para">Copyright &#169; 2021. Made with passion by <a
