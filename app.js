...
app.use(
  cors({
    origin: ["http://localhost:5173", "http://192.168.1.65:5173", "http://localhost:5125", "http://192.168.1.124:5125", "https://fanxange.depthfirstsearch.tk/"], // allow to server to accept request from different origin
